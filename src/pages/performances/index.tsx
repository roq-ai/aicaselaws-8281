          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>accuracy</Th>
                  {hasAccess('ai_model', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>ai_model</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('ai_model', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/ai-models/view/${record.ai_model?.id}`}>
                          {record.ai_model?.name}
                        </Link>
                      </Td>
                    )}
